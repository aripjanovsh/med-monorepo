...
export class TextareaNode extends CustomElementNode {
  ...
  decorate(editor: LexicalEditor, config: EditorConfig): ReactNode {
    return <TextareaComponent data={this.__data} nodeKey={this.__key} editor={editor} />;
  }
}
...
export const INSERT_TEXTAREA_COMMAND = createCommand<CustomElementData>('INSERT_TEXTAREA_COMMAND');
