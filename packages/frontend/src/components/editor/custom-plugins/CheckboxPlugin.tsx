...
export class CheckboxNode extends CustomElementNode {
  ...
  decorate(editor: LexicalEditor, config: EditorConfig): ReactNode {
    return <CheckboxComponent data={this.__data} nodeKey={this.__key} editor={editor} />;
  }
}
...
export const INSERT_CHECKBOX_COMMAND = createCommand<CustomElementData>('INSERT_CHECKBOX_COMMAND');
